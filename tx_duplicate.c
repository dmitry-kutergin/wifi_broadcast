...
usage(void)
{
    printf(
        ...
        "\n"
        "Modified version to send out packets duplicated on two interfaces\n"
        "\n"
        ...
        "\n"
        "Example:\n"
        "  cat /dev/zero | tx -b 8 -r 4 -f 1024 wlan0 wlan1 (reads zeros from stdin and sends them out duplicated on wlan0 and wlan1)\n"
